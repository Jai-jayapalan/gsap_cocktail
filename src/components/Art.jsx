...
const Art = () => {
    ...
    useGSAP(() => {
        ...
        .to('#masked-content', { opacity: 1, duration: 1, ease: 'power1.inOut', y: 50 })
    }, [])
      ...
      <div className='container mx-auto h-full pt-20'>
        ...
        <div className='masked-container'>
            ...
            <div id='masked-content'>
                ...
                <p>This isn't just a drink. It's a carefully crafted experience, designed to delight your senses 
                and elevate your moments.</p>
            </div>
        </div>
      </div>
    </div>
